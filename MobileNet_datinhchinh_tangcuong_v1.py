...
checkpoint = ModelCheckpoint(
    "best_model_khongtinhchinhv1_tangcuong.keras",
...
for fold_no, (train_indices, test_indices) in enumerate(
    ...
    metrics_logger = MetricsLogger(
        f"metrics_khongtinhchinhv1_tangcuong_fold_{fold_no}.log", X_val, y_val
    )
    ...
    save_confusion_matrix(
        ...
        y_pred,
        class_names,
        f"confusion_matrix_khongtinhchinhv1_tangcuong.csv",
    )
    ...
    save_classification_report(
        ...
        y_pred,
        class_names,
        f"classification_report_khongtinhchinhv1_tangcuong.txt",
    )
