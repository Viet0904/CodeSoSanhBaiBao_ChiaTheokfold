...
checkpoint = ModelCheckpoint(
    "best_model_EfficientNetB3_v2_segmentation15_255.keras",
...
for fold_no, (train_indices, test_indices) in enumerate(
    ...
    metrics_logger = MetricsLogger(
        f"metrics_EfficientNetB3_v2_segmentation15_255_fold_{fold_no}.log",
        X_val,
        y_val,
        fold_no,
        f"confusion_matrix_EfficientNetB3_v2_segmentation15_255",
    )
    ...
    save_classification_report(
        ...
        y_pred,
        class_names,
        f"classification_report_EfficientNetB3_v2_segmentation15_255.txt",
    )
