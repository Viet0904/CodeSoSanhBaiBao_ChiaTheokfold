...
checkpoint = ModelCheckpoint(
    "best_model_MobileNetB_segmentation_tangcuong.keras",
...
for fold_no, (train_indices, test_indices) in enumerate(
    ...
    metrics_logger = MetricsLogger(
        f"metrics_MobileNetB_segmentation_tangcuong_fold_{fold_no}.log",
        X_val,
        y_val,
        fold_no,
        f"confusion_matrix_MobileNetB_segmentation_tangcuong",
    )
    ...
    save_classification_report(
        ...
        y_pred,
        class_names,
        f"classification_report_MobileNetB_segmentation_tangcuong.txt",
    )
