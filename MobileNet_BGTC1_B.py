...
for fold_no, (train_indices, test_indices) in enumerate(
    ...
    metrics_logger = MetricsLogger(
        f"metrics_MobileNet_BGTC1_B_tangcuong_fold_{fold_no}.log", X_val, y_val
    )
    ...
    save_confusion_matrix(
        ...
        y_pred,
        class_names,
        f"confusion_matrix_MobileNet_BGTC1_B_tangcuong.csv",
    )
    ...
    save_classification_report(
        ...
        y_pred,
        class_names,
        f"classification_report_MobileNet_BGTC1_B_tangcuong.txt",
    )
