...
checkpoint = ModelCheckpoint(
    "best_model_MobileNetV2_v1_A_tangcuong.keras",
...
for fold_no, (train_indices, test_indices) in enumerate(
    ...
    metrics_logger = MetricsLogger(
        f"metrics_MobileNetV2_v1_A_tangcuong_fold_{fold_no}.log",
        X_val,
        y_val,
        fold_no,
        f"confusion_matrix_MobileNetV2_v1_A_tangcuong",
    )
    ...
    save_classification_report(
        ...
        y_pred,
        class_names,
        f"classification_report_MobileNetV2_v1_A_tangcuong.txt",
    )
