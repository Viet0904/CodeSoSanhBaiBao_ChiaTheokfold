...
checkpoint = ModelCheckpoint(
    "best_model_khongtinhchinhv3_tangcuong.keras",
...
for fold_no, (train_indices, test_indices) in enumerate(
    ...
    metrics_logger = MetricsLogger(
        f"metrics_khongtinhchinhv3_tangcuong_fold_{fold_no}.log"
    )
    ...
    save_confusion_matrix(
        ...
        y_pred,
        class_names,
        f"confusion_matrix_khongtinhchinhv3_tangcuong.csv",
    )
    ...
    save_classification_report(
        ...
        y_pred,
        class_names,
        f"classification_report_khongtinhchinhv3_tangcuong.txt",
    )
